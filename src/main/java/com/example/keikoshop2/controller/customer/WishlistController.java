...
public class WishlistController {
    ...
    public String storeWishlist(Wishlist wishlist, RedirectAttributes redirectAttributes) {
        wishlistService.store(wishlist);
        redirectAttributes.addFlashAttribute("successMessage", "Added to wishlist successfully");
        return "redirect:/products"; // Redirect back to products page or wherever appropriate
    }
