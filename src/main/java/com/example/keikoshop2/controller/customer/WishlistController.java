...
public class WishlistController {
    ...
    public String storeWishlist(@RequestParam int userId, @RequestParam int productId,
    ...
    public String deleteWishlist(@PathVariable int id, RedirectAttributes redirectAttributes,
    ...
    public String updateWishlist(@PathVariable int id, @RequestBody Wishlist updatedWishlist,
            RedirectAttributes redirectAttributes) {
